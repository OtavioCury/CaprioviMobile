...
.controller('relFemeasIdadeReprodutivaCtrl', ['$scope', '$stateParams', '$ionicLoading', 'CaprioviService', '$state', '$rootScope'
...
function ($scope, $stateParams, $ionicLoading, CaprioviService, $state, $rootScope, $ionicPopup, CaprioviFactory) {
	...
	$scope.vazio = false;
	if ($rootScope.relFemeasIdadeReprodutiva.length == 0) {
		$scope.vazio = true;
	};
